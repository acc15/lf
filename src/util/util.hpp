...
namespace leafsync {
    ...
    const T& pick_indexed(bool flag, const T (&values_with_last_default)[N]) {
    ...
    const T& pick_indexed_with_last_default(const K& index, const T (&values_with_last_default)[N]) {
