...
namespace lf {
    ...
    private:
        ...
        using queue_map = std::map<std::string, queue_item>;
        ...
        void add_dir_names(const queue_item& item, const std::filesystem::path* dir_path, queue_map& dest) const;
        void add_state_names(const queue_item& item, queue_map& dest) const;
        void add_index_names(const queue_item& item, queue_map& dest) const;
